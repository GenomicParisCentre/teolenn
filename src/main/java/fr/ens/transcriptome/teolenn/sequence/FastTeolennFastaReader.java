 ...
 */
public class FastTeolennFastaReader {
   ...
   * @param start1 if the first position in the chromosome is 1
   */
  public FastTeolennFastaReader(final File oligosDir, final String extension,
  ...
  public static void main(final String[] args) throws IOException,
    ...
    FastTeolennFastaReader ff =
        new FastTeolennFastaReader(new File("/home/jourdren/tmp/design_toto/oligos"),
            ".oligo", 60, true);
